...
def setup_wandb(args, rank: int, stage: str = "stage1"):
    ...
    try:
        ...
        wandb_run_name = os.environ.get('WANDB_RUN_NAME', f"spiga_{args.dataset}_{stage}")
        ...
        run = wandb.init(
            ...
            name=wandb_run_name,
            config=vars(args),
            tags=[args.dataset, stage, f"world_size_{args.world_size}"],
            mode=wandb_mode,
