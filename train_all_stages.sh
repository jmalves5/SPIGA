...
echo "=========================================="
echo "SPIGA Three-Stage Training Pipeline"
echo "=========================================="
...
# =====================================
# Stage 1: CNN Backbone Pre-training
# =====================================
echo ""
echo "=========================================="
echo "STAGE 1: CNN Backbone Pre-training"
echo "Epochs: 450, Learning Rate: 1e-3"
echo "=========================================="
...
# =====================================
# Stage 2: Fine-tuning with Pose
# =====================================
echo ""
echo "=========================================="
echo "STAGE 2: Fine-tuning (Landmarks + Pose)"
echo "Epochs: 150, Learning Rate: 1e-3"
echo "=========================================="
...
# =====================================
# Stage 3: GAT Regressor Training
# =====================================
echo ""
echo "=========================================="
echo "STAGE 3: GAT Regressor Training"
echo "Epochs: 150, Learning Rate: 1e-4"
echo "GAT Steps: 3 (Backbone Frozen)"
echo "=========================================="
...
echo "  Stage 1: ${CHECKPOINT_DIR}/checkpoint_stage1/best_model.pth"
echo "  Stage 2: ${CHECKPOINT_DIR}/checkpoint_stage2/best_model.pth"
echo "  Stage 3: ${CHECKPOINT_DIR}/checkpoint_stage3/best_model.pth (FINAL)"
echo ""
echo "Logs:"
echo "  ${LOG_DIR}/train_stage*_*.log"
echo ""
